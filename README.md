...
Example workspace for using ROS2 Humble. Initial templated is based from [athackst/vscode_ros2_workspace](https://github.com/athackst/vscode_ros2_workspace)
...
Note the necessary changes to the default `setup.py` file to correctly run the node and lauch file.
